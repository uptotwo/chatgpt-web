...
import { NButton, NDataTable, NImage, NModal, NTabPane, NTabs, useMessage, NPopconfirm, NLayout, NH2, NCard } from 'naive-ui'
...
<template>
    <NModal v-model:show="show" style="width: 70%; max-width: 600px;" preset="card">
        <div class="space-y-4">
            <NTabs type="segment">
                <NTabPane name="planDetail" tab="计划内容">
                    <NLayout >
                        <NCard >
                            <NH2>计划目的</NH2>
                            1.为了提高网站的影响力<br>
                            2.同时为用户获取使用额度提供更多途径<br>
                            因此我们推出了激励计划1.0
                            <NH2>计划细节</NH2>
                            您将拥有自己的网站引荐链接和引荐二维码,<br>
                            当新用户通过您分享的链接或二维码注册成功后,<br>
                            您将获得免费的10次使用额度(时间不限).<br>
                            我们会立即开始统计用户之间的的引荐关系,<br>
                            在后续的迭代中,我们会让您直观的看到引荐关系
                            <NH2>额外影响</NH2>
                            通过您分享的链接或者二维码注册的用户将与您永久绑定引荐关系,<br>
                            后续的计划中受益关系将与引荐关系强关联
                        </NCard>
                    </NLayout>
                </NTabPane>
                <NTabPane name="mySpreadCode" tab="我的推荐码/链接">
                    <NLayout has-sider>
                        <NCard >
                            <NH2>https://ai.chenyl.fun</NH2>
                        </NCard>
                    </NLayout>
                </NTabPane>
            </NTabs>
